...
\textbf{vertex\_update} con los siguientes parámetros:
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{graph}\PY{o}{.}\PY{n}{vertex\PYZus{}update}\PY{p}{(}\PY{n}{source}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{target}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
...
vertex)}\label{insertar-un-nodo-incremental-vertex}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{graph}\PY{o}{.}\PY{n}{print\PYZus{}r}\PY{p}{(}\PY{p}{)}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZhy{}\PYZhy{}Incremental vertex\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{graph}\PY{o}{.}\PY{n}{print\PYZus{}r}\PY{p}{(}\PY{p}{)}
        \PY{n}{graph}\PY{o}{.}\PY{n}{draw}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
vertex)}\label{eliminar-un-nodo-decreasing-vertex}
...
método \textbf{vertex\_update\_random}, sin parámetros.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{random\PYZus{}graph}\PY{o}{.}\PY{n}{vertex\PYZus{}update\PYZus{}random}\PY{p}{(}\PY{p}{)}
         \PY{n}{random\PYZus{}graph}\PY{o}{.}\PY{n}{draw}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
vertex)}\label{insertar-nodo-aleatorio-random-insert-vertex}
...
vertex)}\label{eliminar-nodo-aleatorio-random-delete-vertex}
